...
path_in = "M:/biome_health_project_files/country_files/kenya/working_data/"
...
with open("D:/Fiona/Biome_Health_Project/allfiles_test.txt", "wb") as fp:   #Pickling
   pickle.dump(allfiles, fp)

```

```{r}
r_allfiles<-read.csv("original_filepaths_working_filepaths.csv")
all_files<-r_allfiles$new_file_structure
